...
function Questions() {
  ...
  // Mock Data - Replace with actual API calls using useQuestions hook
  const stats = [
    { label: "Total Questions", value: "247", icon: FileText, color: "text-blue-500", bg: "bg-blue-100" },
    { label: "Topics Covered", value: "8", icon: BookOpen, color: "text-bio-500", bg: "bg-bio-100" },
    { label: "Avg. Difficulty", value: "Medium", icon: TrendingUp, color: "text-dna-500", bg: "bg-dna-100" },
  ];

  const topics = [
    { id: 'all', name: 'All Topics', icon: FileText, count: 247 },
    { id: 'genetics', name: 'Genetics', icon: Dna, count: 45 },
    { id: 'cell-structure', name: 'Cell Structure', icon: Microscope, count: 38 },
    { id: 'evolution', name: 'Evolution', icon: Activity, count: 32 },
    { id: 'ecology', name: 'Ecology', icon: Leaf, count: 28 },
    { id: 'human-biology', name: 'Human Biology', icon: Brain, count: 41 },
    { id: 'plant-biology', name: 'Plant Biology', icon: Leaf, count: 25 },
    { id: 'biochemistry', name: 'Biochemistry', icon: Activity, count: 22 },
    { id: 'molecular-biology', name: 'Molecular Biology', icon: Dna, count: 16 },
  ];
  ...
  const questions = [
    ...
    {
      id: 2,
      text: "Explain the process of mitosis and its significance in multicellular organisms.",
      type: "Essay",
      topic: "Genetics",
      difficulty: "Hard",
      points: 5,
    ...
    {
      id: 4,
      text: "Match the following organelles with their functions.",
      type: "Matching",
      topic: "Cell Structure",
      difficulty: "Medium",
      points: 3,
    ...
    {
      id: 5,
      text: "The powerhouse of the cell is the ________.",
    ...
    {
      id: 6,
      text: "Describe the role of natural selection in evolutionary processes.",
      type: "Short Answer",
      topic: "Evolution",
      difficulty: "Medium",
      points: 3,
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 space-y-4">
            ...
            <button className="w-full py-2 text-sm text-slate-600 hover:text-slate-900 font-medium border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
              Reset Filters
            </button>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mb-3">
                      <span className={`text-xs px-2.5 py-1 rounded-full border font-medium ${getTypeColor(question.type)}`}>
                        {question.type}
                      </span>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-xs text-slate-500">
                      ...
                      <span className="flex items-center gap-1">
                        ...
                        Used in {question.usedInRooms} rooms
                      </span>
                      <span className="text-slate-400">• Created {question.created}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button 
                      className="p-2 text-slate-400 hover:text-dna-600 hover:bg-dna-50 rounded-lg transition-colors"
          ...
          <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-slate-600">
                Showing <span className="font-medium">1-6</span> of <span className="font-medium">247</span> questions
              </p>
              <div className="flex items-center gap-2">
                <button className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                  Previous
                </button>
                <button className="px-3 py-2 text-sm font-medium bg-bio-600 text-white rounded-lg">
                  1
                </button>
                <button className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
                  2
                </button>
                <button className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">
                  3
